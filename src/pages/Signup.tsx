...
import CountryDropdown, { COUNTRIES } from "@/components/auth/CountryDropdown";
...
const Signup = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-background to-background/80 px-4">
      <Helmet>
        <title>Sign Up - Insight Writer AI</title>
      </Helmet>
      ...
      <div className="w-full max-w-md mb-8">
        ...
        <p className="text-foreground/70 mb-8">
          Create an account to start your 14-day free trial. No credit card required.
        </p>
